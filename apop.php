...
<body>
		...
		<div id="header_background">
			...
			<div id="header_navi_background">
				<ul id="navi_ul">
					...
					<li style="background-color: #FFECC9;"><a href="apop.php" class="no_underline_bold">歐美</a></li>
	...
	<div id="product_container">
		...
		<div id="product_right_page">
			...
			<div class="slideShow">
				<ul class="slides">
					<li class="slide"><img src="./img/slideshow_img/apop01.jpg" alt=""></li>
					<li class="slide"><img src="./img/slideshow_img/apop02.jpg" alt=""></li>
					<li class="slide"><img src="./img/slideshow_img/apop03.jpg" alt=""></li>
					<li class="slide"><img src="./img/slideshow_img/apop04.jpg" alt=""></li>
