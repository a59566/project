	...
	<header>
		...
		<div id="album_left">
			<div id="album_content">
				<h1>蒼の彼方のフォーリズム Vocal & Sound Collection</h1>
				<img src="./img/cover/Cover0.jpg" alt="">
				...
				<div id="content_info">
					<div class="content_text">川田まみ</div>
		...
		<?php
			...
			$sql = "SELECT `track_title`,`artist`,`price`FROM `song` WHERE `id`=1";
