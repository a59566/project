...
<body>
	...
	<div id="product_container">
		...
		<div id="product_right_page">
			...
			<div class="slideShow">
				<ul class="slides">
					<li class="slide"><a href=""><img src="./img/slideshow_img/jkpop01.jpg" alt=""></a></li>
					<li class="slide"><a href=""><img src="./img/slideshow_img/jkpop02.jpg" alt=""></a></li>
					<li class="slide"><a href=""><img src="./img/slideshow_img/jkpop03.jpg" alt=""></a></li>
					<li class="slide"><a href=""><img src="./img/slideshow_img/jkpop04.jpg" alt=""></a></li>
